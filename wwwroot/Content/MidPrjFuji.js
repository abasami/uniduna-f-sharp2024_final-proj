...
{
 "use strict";
 var MidPrjFuji,Client,WebSharper,Obj,UI,Var$1,ListModel,Entry,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Var,Handler,Object,Unchecked,MidPrjFuji_Templates,Seq,Doc,TemplateHole,ConcreteVar,Snap,Numeric,TemplateHoleModule,TextView,VarStr,VarIntUnchecked,Elt,System,Guid,EventQ,JavaScript,Pervasives,Strings,Client$1,Templates,Enumerator,T,Array,Text,Abbrev,Fresh,Storage,View,Collections,Dictionary,EventTarget,Node,JS,HashSet,TemplateInitializer,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,List,T$1,ArrayStorage,DictionaryUtil,WindowOrWorkerGlobalScope,SC$1,Docs,DocElemNode,CharacterData,SC$2,Blob,Elt$1,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Attribute,Event,AttrModule,AttrProxy,AfterRender,AfterRenderQ,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,SC$4,SC$5,AppendList,DynamicAttrNode,Error,KeyNotFoundException,SC$6,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,Queue,BindVar,String,CheckedInput,CancellationTokenSource,DomNodes,Char,DateUtil,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,Date,String$1,Runtime$1,console,Math;
 MidPrjFuji=Global.MidPrjFuji=Global.MidPrjFuji||{};
 Client=MidPrjFuji.Client=MidPrjFuji.Client||{};
 ...
 {
  var newEntryCoffeeName,newEntryMyNote,newEntryLevel,msg,cap,recipe,result,allCoffee,Coffee,data,_,b,t,t$1,R,_this,R$1,_this$1,_this$2,_this$3,_this$4,_this$5,_this$6,C,_this$7,p,i;
  function row(entry)
  {
   var b$1,_this$8,_this$9,_this$10,_this$11,p$1,i$1;
   return(b$1=(_this$8=(_this$9=(_this$10=(_this$11=new ProviderBuilder.New$1(),(_this$11.h.push(new Text.New("registereddate",entry.RegisterdDate)),_this$11)),(_this$10.h.push(new Text.New("coffeename",entry.CoffeeName)),_this$10)),(_this$9.h.push(new Text.New("mynote",entry.MyNote)),_this$9)),(_this$8.h.push(new Text.New("level",Global.String(entry.Level))),_this$8)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],MidPrjFuji_Templates.row(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  }
  newEntryCoffeeName=Var$1.Create$1("");
  newEntryMyNote=Var$1.Create$1("");
  newEntryLevel=Var$1.Create$1(5);
  msg=Var$1.Create$1("");
  cap=Var$1.Create$1("=== REGISTERED COFFEE ===");
  recipe=Var$1.Create$1("Information about the coffee you selected will be displayed here.");
  result=Var$1.Create$1("");
  allCoffee=ListModel.FromSeq([Entry.Create("","Blue Mountain","Most Favorite!",5),Entry.Create("","Kona","The second-time purchased",5),Entry.Create("","Kilimanjaro","",4),Entry.Create("","Mocha","",4),Entry.Create("","Java coffee","",3),Entry.Create("","Toraja","",3),Entry.Create("","Mandheling","",3)]);
  Coffee=ListModel.FromSeq([]);
  allCoffee.Iter(function(t$2)
  {
   Coffee.Append(Entry.Create(t$2.RegisterdDate,t$2.CoffeeName,t$2.MyNote,t$2.Level));
  });
  data=Doc.BindView(function(lm)
  {
   return Doc.Concat(Seq.map(row,Seq.sortBy(function(t$2)
   {
    return t$2.CoffeeName;
   },lm)));
  },Coffee.v);
  _=(b=(t=(t$1=(R=result.get_View(),(_this=(R$1=recipe.get_View(),(_this$1=(_this$2=(_this$3=(_this$4=(_this$5=(_this$6=(C=cap.get_View(),(_this$7=new ProviderBuilder.New$1(),(_this$7.h.push(new TextView.New("caption",C)),_this$7))),(_this$6.h.push(new Elt.New("data",data)),_this$6)),(_this$5.h.push(new VarStr.New("coffeename",newEntryCoffeeName)),_this$5)),(_this$4.h.push(new VarStr.New("mynote",newEntryMyNote)),_this$4)),(_this$3.h.push(new VarIntUnchecked.New("level",newEntryLevel)),_this$3)),(_this$2.h.push(new VarStr.New("msg",msg)),_this$2)),(_this$1.h.push(new TextView.New("recipe",R$1)),_this$1))),(_this.h.push(new TextView.New("result",R)),_this))),(t$1.h.push(Handler.EventQ2(t$1.k,"reister",function()
  {
   return t$1.i;
  },function()
  {
   var date;
   cap.Set("=== REGISTERED COFFEE ===");
   Coffee.Clear();
   date=Global.String((new Global.Date(Date.now())).getFullYear())+"/"+Global.String((new Date(Date.now())).getMonth()+1)+"/"+Global.String((new Date(Date.now())).getDate());
   Coffee.Append(Entry.Create(date,newEntryCoffeeName.Get(),newEntryMyNote.Get(),newEntryLevel.Get()));
   allCoffee.Iter(function(t$2)
   {
    Coffee.Append(Entry.Create(t$2.RegisterdDate,t$2.CoffeeName,t$2.MyNote,t$2.Level));
   });
   allCoffee.Clear();
   Coffee.Iter(function(t$2)
   {
    allCoffee.Append(Entry.Create(t$2.RegisterdDate,t$2.CoffeeName,t$2.MyNote,t$2.Level));
   });
   recipe.Set(newEntryCoffeeName.Get()=="Blue Mountain"?"BLUE MOUNTAIN has an outstanding aroma, a harmonious taste, a light texture, and a smooth finish.It is said to be of the highest quality. A small percentage of the coffee produced in Jamaica is branded as Blue Mountain.Among them, it is further ranked"+String$1.fromCharCode(10)+"Enjoy the taste straight!":newEntryCoffeeName.Get()=="Java Coffee"?"JAVA COFFEE is Mainly refers to Arabica coffee grown on the island of Java. Round and mild taste."+String$1.fromCharCode(10)+"Enjoy the taste Iced Coffee!":newEntryCoffeeName.Get()=="Kilimanjaro"?"KILIMANJARO is a name for coffee produced in Tanzania.  Characterized by strong acidity and richness.Deep roasts, which are often described as 'full of wildness', have an elegant bitterness that is different from light to medium roasts.":newEntryCoffeeName.Get()=="Kona"?"KONA has a very strong sourness and rich flavor.It is said to give a good acidity when used in blends, and is the second most expensive brand after Blue Mountain..":newEntryCoffeeName.Get()=="Mandheling"?"MANDHEILING comes from Sumatra. The taste is mainly bitter and full-bodied, with no acidity and a unique aftertaste.":newEntryCoffeeName.Get()=="Mocha"?"MOCHA has an excellent aroma and a unique sourness, adding sweetness and richness.It is the oldest brand. It is the origin of coffee, and in Italy and other countries coffee is called mocha.Famous include ``Matali'' from Yemen, ``Harar'' and ``Sidamo'' from Ethiopia.":newEntryCoffeeName.Get()=="Toraja"?"TORAJA comes from Sulawesi. The taste is mainly bitter, with a very rich flavor and no sourness..":"Cofee \""+String$1(newEntryCoffeeName.Get())+"\" from \""+newEntryMyNote.Get()+"\" is registerd.");
   result.Set("As of "+date+" , the number of lists you have registered is "+String$1(Coffee.get_Length())+".");
   msg.Set("Coffee \""+String$1(newEntryCoffeeName.Get())+"\" Note: \""+String$1(newEntryMyNote.Get())+"\" Level: \""+String$1(newEntryLevel.Get())+"\" is added to the LIST.");
   newEntryCoffeeName.Set("");
   newEntryMyNote.Set("");
   newEntryLevel.Set(5);
  ...
  },function()
  {
   ...
   {
    var c,c$1;
    if((Strings.Trim(newEntryCoffeeName.Get())==""||t$2.CoffeeName.toLowerCase().indexOf(newEntryCoffeeName.Get().toLowerCase())!=-1)&&(Strings.Trim(newEntryMyNote.Get())==""||t$2.MyNote.toLowerCase().indexOf(newEntryMyNote.Get().toLowerCase())!=-1)&&(c=newEntryLevel.Get(),Unchecked.Equals(c,"")||String$1(t$2.Level).indexOf((c$1=newEntryLevel.Get(),String$1(c$1)))!=-1))
     Coffee.Append(Entry.Create(t$2.RegisterdDate,t$2.CoffeeName,t$2.MyNote,t$2.Level));
   });
   msg.Set(Coffee.get_Length()===0?(Coffee.Append(Entry.Create("","","",0)),"Coffee \""+newEntryCoffeeName.Get()+"\" Note: \""+newEntryMyNote.Get()+"\" is not found."):"Coffee \""+newEntryCoffeeName.Get()+"\" Note: \""+newEntryMyNote.Get()+"\" is found, "+String$1(Coffee.get_Length())+(Coffee.get_Length()===1?" Coffee.":" Coffee."));
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["coffeename",0,null],["mynote",0,null],["level",1,null],["msg",0,null]]),(i=new TemplateInstance.New(p[1],MidPrjFuji_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Entry.Create=function(regdate,coffeename,productionarea,level)
 {
  return Entry.New(regdate,coffeename,productionarea,level);
 };
 Entry.New=function(RegisterdDate,CoffeeName,MyNote,Level)
 {
  return{
 ...
 ProviderBuilder.New$1=Runtime$1.Ctor(function()
 {
  ...
  Obj.New.call(this);
  this.i=null;
  this.k=(c=Guid.NewGuid(),String$1(c));
 ...
 MidPrjFuji_Templates.main=function(h)
 {
 ...
 MidPrjFuji_Templates.row=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 VarStr=TemplateHoleModule.VarStr=Runtime$1.Class({
  ...
  get_AsChoiceView:function()
  {
   return{
    $:1,
    $0:View.Map(String$1,this.fillWith.get_View())
   };
  }
 },TemplateHole,VarStr);
 ...
 VarIntUnchecked=TemplateHoleModule.VarIntUnchecked=Runtime$1.Class({
  get_Name:function()
  {
   return this.name;
  },
 ...
 VarIntUnchecked.New=Runtime$1.Ctor(function(name,fillWith)
 {
  TemplateHole.New.call(this);
  this.name=name;
  this.fillWith=fillWith;
